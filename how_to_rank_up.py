...
__Example:__ To obtain the rank of Crusader, you need 4000 points, with at 
...
-If you want to see a more detailed breakdown of your points, use the command !fullpoints instead
-Here is an example of the detailed points image:'''
