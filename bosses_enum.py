...
class Bosses(Enum):
    ABYSSAL_SIRE, ALCHEMICAL_HDYRA, ARTIO, BARROWS, BRYOPHYTA, CALLISTO, \
        ...
        KRIL_TSUTSAROTH, MIMIC, NEX, NIGHTMARE, PHOSANIS_NIGHTMARE, OBOR, \
        PHANTOM_MUSPAH, SARACHNIS, SCORPIA, SKOTIZO, SPINDEL, TEMPOROSS, \
        GAUNTLET, CORRUPTED_GAUNTLET, LEVIATHAN, WHISPERER, TOB, TOB_HM, \
        THERMONUCLEAR_SMOKE_DEVIL, TOA, TOA_HM, ZUK, JAD, VARDORVIS, \
        VENENATIS, VETION, VORKATH, WINTERTODT, ZALCANO, ZULRAH = range(40, 98)
